...
SEQUENTIAL_ENVIRONMENT_SPECS = (
    ...
    {
        'id': 'SawyerRigAffordancesNoPNP-v6',
        'entry_point': ('roboverse.envs.sawyer_rig_affordances_v6_2obj:SawyerRigAffordancesV6_noPNP'),
        'kwargs': {'max_force': 100,
                   'action_scale': 0.05,
                   'pos_low': [0.5,-0.2,-.36],
                   'pos_high': [0.85,0.2,-0.1],
    ...
    {
        'id': 'SawyerRigAffordancesNoDrawer-v6',
        'entry_point': ('roboverse.envs.sawyer_rig_affordances_v6_2obj:SawyerRigAffordancesV6_noDrawer'),
        'kwargs': {'max_force': 100,
                   'action_scale': 0.05,
                   'pos_low': [0.5,-0.2,-.36],
                   'pos_high': [0.85,0.2,-0.1],
    ...
    {
        'id': 'SawyerRigAffordancesNoSlide-v6',
        'entry_point': ('roboverse.envs.sawyer_rig_affordances_v6_2obj:SawyerRigAffordancesV6_noSlide'),
        'kwargs': {'max_force': 100,
                   'action_scale': 0.05,
                   'pos_low': [0.5,-0.2,-.36],
                   'pos_high': [0.85,0.2,-0.1],
